Dado('que faço uma requisição GET para o endpoint de obter autores') do           
    @response = @services.authors.get_authors   #faz a chamada ao metodo e guarda na variavel @response o resultado da chamada ao metodo
end                                                                               
...
expect(@response.code).to eq status  #espero que o resultado do response seja status 200                                    
end    